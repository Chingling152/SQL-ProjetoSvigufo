...
--- RETORNA UMA QUANTIDADE DE CONVITES COM A MESMA SITUAÇÃO --
CREATE PROCEDURE VerPorSituacao @PAGINA INT , @QUANTIDADE INT, @SITUACAO INT
AS
BEGIN
SELECT * FROM VerConvites WHERE SITUACAO = @SITUACAO
ORDER BY DATA_EVENTO DESC
OFFSET @QUANTIDADE ROWS FETCH NEXT @PAGINA ROWS ONLY;
END
GO
