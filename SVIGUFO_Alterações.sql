...
CREATE PROCEDURE AlterarConvite @ID INT, @ID_USARIO INT , @ID_EVENTO INT, @SITUACAO INT 
AS
BEGIN
UPDATE CONVITES SET ID_USUARIO = @ID_USARIO , ID_EVENTO = @ID_EVENTO ,SITUACAO = @SITUACAO WHERE ID = @ID;
END
GO